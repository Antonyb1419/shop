...
namespace Shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await this.CheckUserAsync("brad@hotmail.com", "Brad", "Pit", "Customer");
            await this.CheckUserAsync("angelina@hotmail.com", "Angelina", "Jolie", "Customer");
            var user = await this.CheckUserAsync("antony_esnaider_11@hotmail.com", "Antony", "Ancajima", "Admin");
